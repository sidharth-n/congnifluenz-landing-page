...
export const products = [
    ...
    benefits: [
      {
        ...
        description:
          "Save up to 95% on bandwidth and storage costs compared to traditional compression methods.",
        icon: <Gauge size={24} className="text-primary" />,
      },
      {
        title: "Accelerated Processing",
        description:
          "Process 10-50x more video streams with the same infrastructure, enabling massive scalability.",
        icon: <Zap size={24} className="text-primary" />,
      },
      {
        title: "Edge Device Efficiency",
        description:
          "Extend battery life and reduce hardware requirements for edge deployments.",
        icon: <Scale size={24} className="text-primary" />,
      },
      {
        title: "Scalable Deployment",
        description:
          "Seamlessly handle thousands of camera streams without infrastructure overhaul.",
    ...
    applications: [
      {
        ...
        description:
          "Enable comprehensive traffic monitoring, public safety, and urban planning analytics at city-wide scale.",
        icon: <Building2 size={36} />,
      },
      {
        industry: "Autonomous Vehicles",
        description:
          "Efficiently transmit critical visual data between vehicles and infrastructure while minimizing latency.",
        icon: <Car size={36} />,
      },
      {
        industry: "Retail Analytics",
        description:
          "Scale in-store customer behavior analysis and inventory monitoring across large retail operations.",
        icon: <ShoppingCart size={36} />,
      },
      {
        industry: "Industrial Monitoring",
        description:
          "Deploy comprehensive visual inspection systems across manufacturing facilities.",
        icon: <Factory size={36} />,
      },
      {
        industry: "Content Moderation",
        description:
          "Process massive video content volumes for efficient automated content moderation.",
    ...
    benefits: [
      {
        ...
        description:
          "Make critical decisions during flight instead of waiting for post-processing.",
        icon: <Timer size={24} className="text-primary" />,
      },
      {
        title: "Cost Efficiency",
        description:
          "Use standard drone equipment without expensive LiDAR or multi-camera arrays.",
        icon: <Gauge size={24} className="text-primary" />,
      },
      {
        title: "Simplified Workflow",
        description:
          "Eliminate complex post-processing steps with our automated pipeline.",
        icon: <LayoutGrid size={24} className="text-primary" />,
      },
      {
        title: "Enhanced Safety",
        description:
          "Identify structural issues immediately without repeat flight missions.",
    ...
    applications: [
      {
        ...
        description:
          "Instantly identify structural issues in bridges, towers, and buildings during inspection flights.",
        icon: <Building size={36} />,
      },
      {
        industry: "Emergency Response",
        description:
          "Create instant 3D maps of disaster areas for improved coordination and planning.",
        icon: <Rocket size={36} />,
      },
      {
        industry: "Construction Monitoring",
        description:
          "Track construction progress against plans with accurate volumetric measurements.",
        icon: <Construction size={36} />,
      },
      {
        industry: "Mining & Quarrying",
        description:
          "Generate precise volume calculations and site surveys in a single flight.",
        icon: <Mountain size={36} />,
      },
      {
        industry: "Environmental Mapping",
        description:
          "Create detailed terrain models for environmental monitoring and land management.",
        icon: <MapPin size={36} />,
      },
    ],
    specifications: {
  ...
  },
  {
    ...
    description:
      "Our AI-powered solution revolutionizes analytical instrument data processing with automated baseline correction, enhanced peak detection, and intelligent noise reduction.",
    fullDescription:
      "SpectraCore AI™ transforms analytical instrument data processing through advanced AI algorithms that automate baseline correction, enhance peak detection, and intelligently reduce noise. This powerful solution dramatically improves the accuracy and efficiency of spectral analysis across pharmaceutical research, environmental monitoring, and material science applications.",
    icon: <Waves size={40} />,
    ...
    benefits: [
      {
        title: "Save Time",
        description:
          "Reduce manual processing time by up to 75% with automated data enhancement.",
        icon: <Timer size={24} className="text-primary" />,
      },
      {
        title: "Ensure Consistency",
        description:
          "Eliminate variation between analysts with standardized processing algorithms.",
        icon: <BadgeCheck size={24} className="text-primary" />,
      },
      {
        title: "Enhance Confidence",
        description:
          "Detect previously missed features and reduce false positives in complex data.",
        icon: <BarChart size={24} className="text-primary" />,
      },
      {
        title: "Accelerate Discovery",
        description:
          "Focus on interpretation rather than data processing for faster insights.",
    ...
    applications: [
      {
        ...
        description:
          "Accelerate drug discovery with more accurate compound identification and characterization.",
        icon: <Flask size={36} />,
      },
      {
        industry: "Environmental Monitoring",
        description:
          "Improve detection of trace contaminants in complex environmental samples.",
        icon: <MapPin size={36} />,
      },
      {
        industry: "Materials Science",
        description:
          "Enhance characterization of advanced materials with superior signal analysis.",
        icon: <Cpu size={36} />,
      },
      {
        industry: "Food & Beverage Analysis",
        description:
          "Ensure product quality and safety with more sensitive contaminant detection.",
        icon: <ShoppingCart size={36} />,
      },
      {
        industry: "Clinical Diagnostics",
        description:
          "Improve sensitivity and specificity of diagnostic tests through enhanced signal processing.",
        icon: <Heart size={36} />,
      },
    ],
    specifications: {
